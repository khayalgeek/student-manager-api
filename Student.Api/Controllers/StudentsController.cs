...
namespace Student.Api.Controllers
{
    ...
    {
        private readonly IBaseRepository<Entity.Student.Student?, int> _studentRepository;
        private readonly IBaseRepository<Family?, int> _familyRepository;

        public StudentsController(IBaseRepository<Entity.Student.Student?, int> studentRepository, IBaseRepository<Family?, int> familyRepository)
        {
